...
def main():
    ...
    odg.draw()
    pre_defined_headers = {"Authorization": f"Bearer {test_args[2]}"}
    # return
    ...
    api_fuzzer = APIFuzzer(apis, parser.specification, odg, test_args[1], pre_defined_headers=pre_defined_headers,time_budget=3600)
    api_fuzzer.run()
